...
* `InputLayer` (not mandatory, [link to docs](https://www.tensorflow.org/api_docs/python/tf/keras/layers/InputLayer))
* `Dense` ([link to docs](https://www.tensorflow.org/api_docs/python/tf/keras/layers/Dense))
